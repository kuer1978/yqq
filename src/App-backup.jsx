      ...
      <nav className={`fixed w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-white/90 backdrop-blur-xl shadow-sm py-3' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <a href="#" className="flex items-center space-x-2 group cursor-pointer">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-cyan-400 rounded-xl flex items-center justify-center shadow-lg shadow-blue-200 group-hover:rotate-12 transition-transform">
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-slate-900 p-8 rounded-[2.5rem] text-white shadow-xl">
                ...
                <div className="text-slate-400 text-[10px] uppercase tracking-wider">伤病预防研究</div>
              </div>
              <div className="bg-blue-600 p-8 rounded-[2.5rem] text-white shadow-xl mt-12">
                ...
                <div className="text-blue-100 text-[10px] uppercase tracking-wider">生物安全性</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="products" className="py-32 px-6 scroll-mt-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center" id="agriculture">
            <div className="bg-slate-200 aspect-square rounded-[3.5rem] overflow-hidden shadow-inner flex items-center justify-center text-slate-400 italic">
               {activeTab === 'water' && "[水素生活袋装水 3.48ppm]"}
               {activeTab === 'bath' && "[智能氢浴机 YSPA08]"}
               {activeTab === 'agri' && "[氢水灌溉农业系统]"}
            </div>
            <div className="space-y-8">
              {activeTab === 'water' && (
                <>
                  <h3 className="text-3xl font-bold">水素生活 · 含氢饮用水</h3>
                  <p className="text-slate-500 text-lg leading-relaxed">Monde Selection 金奖品质，采用非电解溶氢技术，让每一口水都成为身体的“除锈剂”。</p>
                  <div className="grid grid-cols-2 gap-4">
                    {["非电解专利", "铝箔阻氧包装"].map(t => <div key={t} className="bg-blue-50 p-4 rounded-xl font-bold text-blue-700 text-center">{t}</div>)}
                  </div>
                </>
              )}
              {activeTab === 'bath' && (
                <>
                  ...
                  <p className="text-slate-500 text-lg leading-relaxed">20分钟提升体温1℃，唤醒免疫系统。通过皮下吸收，让自愈力飞跃提升。</p>
                  <div className="bg-blue-600 p-6 rounded-2xl text-white">
                    <div className="text-4xl font-bold mb-1">5~6 倍</div>
